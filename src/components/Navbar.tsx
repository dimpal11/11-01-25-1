    ...
    <>
      ...
      <nav className="lg:flex items-center space-x-6 relative bg-[#F4EBDD] p-2 pl-6 hidden">
        ...
        <div className="relative">
          ...
          {openDropdown === "web" && (
            <ul className="absolute bg-white text-left  shadow-md rounded py-0 w-36 border border-[#F1E5D1] transition-transform duration-300 transform ease-in-out text-left">
              <li>
                <a
                  href="/web/design"
